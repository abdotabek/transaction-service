...
public interface TransactionController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Transaction authorized successfuly with code 00(PROCESSED)",
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Trasactions retrieved by account id",
